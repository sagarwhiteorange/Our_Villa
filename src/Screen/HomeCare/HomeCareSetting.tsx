...
const HomeCareSetting = (props: any) => {
    ...
    <View>
      <AppBg />
        ...
        <View style={[Styles.marginHorizontal15]}>
          ...
          <TouchableOpacity style={[Styles.flexRow, Styles.JustifyBetween, Styles.mb20]}>
            <View style={[Styles.flexRow, Styles.justifyCenter]}>
              <Image source={Images.notification} style={Styles.SettingIcon} />
              <Text style={[Styles.fontMedium15, Styles.pl10, Styles.fontBook16]}>{Strings.Notification}</Text>
            </View>
            <Image source={Images.next} style={Styles.authIconWidth} />
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.flexRow, Styles.JustifyBetween, Styles.mb20]}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('UserSelect')}>
            <Text style={[Styles.fontMedium18, Styles.textRed, Styles.textCenter, {textDecorationColor: '#EB5757', textDecorationLine: 'underline', textDecorationStyle: 'dashed',}]}>{Strings.LogOut}</Text>
          </TouchableOpacity>
        </View>
    </View>
  );
...
export default HomeCareSetting;
